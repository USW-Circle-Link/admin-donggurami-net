...
export interface IphoneProps extends HTMLAttributes<HTMLDivElement> {
  src?: string
  videoSrc?: string
  /** Punch out the screen area (transparent) without requiring media content */
  transparent?: boolean
}
...
export function Iphone({
  ...
  const applyMask = hasMedia || transparent
  ...
  return (
    ...
    >
      ...
      >
        <g mask={applyMask ? "url(#screenPunch)" : undefined}>
          <path
        ...
        <path
          ...
          mask={applyMask ? "url(#screenPunch)" : undefined}
        />
